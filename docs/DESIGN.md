# Octobot System Design

This document describes the architecture and design of Octobot, an IDE-like chat interface for managing coding sessions with AI agents.
...
- [api.md](../api.md) - Implementation progress
