...
func TestSessionInitialize_SetsWorkspaceCommitOnFirstInit(t *testing.T) {
	...
	sessionSvc := service.NewSessionService(ts.Store, gitSvc, ts.MockSandbox, nil, nil, nil, nil, nil, nil)
...
func TestSessionInitialize_NoGitService(t *testing.T) {
	...
	sessionSvc := service.NewSessionService(ts.Store, nil, ts.MockSandbox, nil, nil, nil, nil, nil, nil)
