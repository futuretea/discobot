...
- Exported individual functions instead of the NextAuth object`,
  ...
  },
  {
    id: "msg-5",
    role: "user",
    content: "Great! Now update the middleware to use Supabase session handling.",
    turn: 3,
  },
  {
    id: "msg-6",
...
export const mockTerminalLines = [
  ...
  { type: "output" as const, content: "Welcome to Ubuntu 22.04.3 LTS (GNU/Linux 5.15.0-91-generic x86_64)" },
  { type: "output" as const, content: "Last login: Thu Jan 9 10:23:45 2026 from 192.168.1.100" },
  ...
  {
    type: "output" as const,
    content: "[PM2] Applying action restartProcessId on app [all](ids: 0,1)\n[PM2] [my-app](0) ✓\n[PM2] [my-app](1) ✓",
  },
]
